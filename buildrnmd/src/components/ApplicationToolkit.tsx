    ...
    <div className="text-center py-10 mb-16 bg-gradient-to-br from-blue-50 via-purple-200 to-pink-200 relative overflow-hidden">
      ...
      <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto mb-8 mt-20">
        ...
        <span className="font-semibold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">
          compelling healthcare applications!
        </span>{" "}
        Templates, guides, and resources designed specifically for Canadian
        students. 🎯
      </p>
      <div className="flex flex-wrap justify-center gap-4 mt-20">
        ...
        <button className="px-8 py-4 border-2 bg-white border-blue-500 text-blue-600 font-semibold rounded-xl hover:bg-blue-50 hover:scale-105 transition-all duration-300 flex items-center gap-2">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
